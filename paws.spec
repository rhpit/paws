...
%changelog
* Wed Aug 08 2017 Eduardo Cerqueira <ecerquei@redhat.com>
 - removed ansible pip, now installed by rpm manager
* Tue Mar 21 2017 Eduardo Cerqueira <ecerquei@redhat.com>
 - Added git in required packages to be installed with paws
* Wed Feb 22 2017 Ryan Williams <rywillia@redhat.com>
 - Fix path to man file to have man page working again
* Fri Feb 17 2017 Ryan Williams <rywillia@redhat.com>
 - Added bash completion script to be part of rpm
* Thu Nov 03 2016 Eduardo Cerqueira <ecerquei@redhat.com>
 - USERDIR setfacl for sudo_user
* Mon Oct 31 2016 Eduardo Cerqueira <ecerquei@redhat.com>
...
* Fri Oct 07 2016 Ryan Williams <rywillia@redhat.com>
- Modify the user directory folder
* Mon Sep 19 2016 Eduardo Cerqueira <ecerquei@redhat.com>
- set permission to 755 for all files after install
* Thu Jul 14 2016 Eduardo Cerqueira <ecerquei@redhat.com>
- initial build
